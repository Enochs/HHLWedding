...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="crumb-wrap wrap-Title">
        <i class="Hui-iconfont">&#xe67f;</i> 首页 
                ...
                <span class="c-gray en">&gt;</span> 酒店列表 
                                ...
                                <ItemTemplate>
                                    <tr id='<%#Eval("HotelID") %>'>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info btn-xs" onclick='OpenUpdate(<%#Eval("HotelID") %>)' data-original-title="编辑酒店" data-toggle="tooltip"><i class="icon-edit"></i></a>
