                    ...
                    <div class="pull-right mail-search">
                        <div class="input-group">
                            <div class="input-group-btn">
                                <input type="text" class="form-control input-sm" style="width: 110px;" id="fromEmployee" name="fromEmployee" placeholder="发件人姓名" />
                                <input type="text" class="form-control input-sm" style="width: 165px;" id="search" name="search" placeholder="搜索邮件标题,正文等" />
                            </div>
                            <div class="input-group-btn">
