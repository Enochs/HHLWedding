...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
           <%-- $("#ddlAllParentSystem").change(function () {
                var parent = $(this).val();
                hhl.ajax("/WebService/ChannelHandler.asmx/GetMaxSort", { parent: parent }, function (result) {
                    if (result.d.IsSuccess) {
                        $("#txtSort").val(result.d.Value);
                        $("#<%=txtChannelGetType.ClientID %>").val(result.d.type);
                    } else {
            ...
            <table id="tblSystem" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td style="vertical-align: top;">
                        <asp:TextBox runat="server" ID="txtChannelGetType" CssClass="form-control" /></td>
                </tr>
                <tr>
