...
namespace HHLWedding.BLLAssmbly
{
    public class Department : ICRUDInterface<Sys_Department>
    {
        ...
        public string GetMaxSort(int itemLevel, int parent)
        {
            ...
            else
            {
                ...
                if (max == "0")
                {
                    ...
                    string pre = "";
                    for (int i = 0; i < HHLConsts.DepartmentMaxLength; i++)
                    {
                        pre += "0";
                    }
        ...
        public List<Sys_Department> GetAllByPager(List<PMSParameters> pars, string orderName, int page, int pageSize, out int sourceCount)
        {
            throw new NotImplementedException();
        }

        public List<Sys_Department> GetAllByPage(int pageIndex, int pageSize, List<Expression<Func<Sys_Department, bool>>> parmList, string sort, out int count)
        {
            throw new NotImplementedException();
        }
    }
